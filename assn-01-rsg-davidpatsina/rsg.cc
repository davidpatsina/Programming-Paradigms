...
static void generateRandomSentence(const string& nonterminal, map<string, Definition>& grammar, vector<string>& sentence){
...
int main(int argc, char *argv[])
{
  ...
  for (int i = 0; i < 3; i++) {
    vector<string> sen;
    generateRandomSentence("<start>", grammar, sen);
